...
public class Main {
    ...
    /**
     * 그룹 단어란 단어에 존재하는 모든 문자에 대해서 각 문자가 연속해서 나타나는 경우만을 말한다 예를 들어
     * ccazzzbb는 c,a,z,e가 모두 연속해서 나타나고 kin도 k,i,n이 연속해서 나타나기 때문에 그룹 단어이지만
    ...
    static boolean checkStr(String str){
        ...
        return true; //여기까지 걸리지지 않았다는 것은 그룹문자 => true 반환
    }
}